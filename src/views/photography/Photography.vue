<template>
  <div>
    ...
    <div class="tag-group">
      ...
      <el-input v-model="search.tag" placeholder="请输入要搜索的标签" style="width:200px;margin-right:20px;height: 32px;line-height: 32px;">
    ...
    <el-row>
      <el-col :span="8" v-for="index in pictures" :key="index">
        <el-card :body-style="{ padding: '10px'}">
          <img :src=pictures[i++] class="image" alt="图片出错">
