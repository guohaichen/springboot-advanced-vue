    ...
    <div>
      ...
      <div v-for="(item, i) in comments"
        ...
        <div class="icon-btn">
          ...
          <i v-if="item.likeFlag"
             class="iconfont el-icon-caret-top likeIcon"
             @click="like(item.id)"></i>
          <i v-else class="iconfont el-icon-caret-top" @click="like(item.id)"></i>{{ item.like }}
        </div>
        <div class="talk-box">
          <p>
        ...
        <div class="reply-box">
          <div v-for="(reply, j) in item.reply" :key="j" class="author-title">
            ...
            <div class="icon-btn">
              ...
              <i v-if="reply.likeFlag" class="iconfont el-icon-caret-top likeIcon" @click="like(reply.id)"></i>
              <i v-else class="iconfont el-icon-caret-top" @click="like(reply.id)"></i>{{ reply.like }}
            </div>
            <div class="talk-box">
              <p>回复<span> @{{ reply.parentName }}: </span>
